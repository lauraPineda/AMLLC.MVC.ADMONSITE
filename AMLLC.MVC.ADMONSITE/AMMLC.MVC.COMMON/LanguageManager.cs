...
namespace AMMLC.MVC.COMMON
{
    public class LanguageMang
    {
        /// <summary>
        /// Crea una lista de los lenguajes disponibles para la aplicación
        /// </summary>
        ...
        /// <summary>
        /// Vallida si el lenguaje configurado por el usuario esta disponible en la
        /// aplicación
        /// </summary>
        ...
        /// <summary>
        /// Obtiene el lenguaje por default de la aplicación
        /// </summary>
        /// <returns></returns>
        ...
        /// <summary>
        /// Realiza el cambio de lenguaje en la aplicación
        /// </summary>
        /// <param name="lang"></param>
